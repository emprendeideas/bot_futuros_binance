    ...
    for intento in range(5):  # máximo 5 intentos
        try:
            ...
            if response.status_code == 418:
                print("🚫 IP BLOQUEADA POR BINANCE (418). Esperando 10 minutos...", flush=True)
...
if __name__ == "__main__":
    ...
    def run_bot():
        ...
        # 🔁 CARGA DE HISTÓRICO CON REINTENTO CONTROLADO
        while True:
            cargar_historico()
            ...
            print("⏳ Error cargando histórico. Reintentando en 5 minutos...", flush=True)
            time.sleep(300)
