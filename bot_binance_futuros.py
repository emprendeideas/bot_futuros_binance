...
def on_message(ws, message):
    ...
    print("📩 Nueva vela cerrada recibida", flush=True)  # 🔥 debe salir cada 1 min

    # Vela Cerrada
    ultimo_precio = float(k["c"])

    # # 🔥 STOP LOSS en cierre de vela (igual que Pine)
    ...
    while True:
        try:
            ...
            ws = websocket.WebSocketApp(
                ...
                on_close=lambda ws, code, msg: print(f"⚠️ WS cerrado", flush=True),
            )
        ...
        print("🔄 Reintentando en 5s...", flush=True)
        time.sleep(5)
